        ...
        return (
            <div>
                <Layout themeСhange={this.themeСhange} theme={this.state.theme} userId={this.state.userId} toOut={this.toOut} userName={this.state.userName}>
                    {this.state.userId && <Route exact path='/marks/' render={() => <ThingsList theme={this.state.theme} token={this.token} userId={this.state.userId} />} />}
                    {!this.state.userId && <Route exact path='/marks/' render={() => <Auth theme={this.state.theme} logIn={this.logIn} toRegister={this.toRegister} />} />}
                </Layout>
            </div>
        );
    }
